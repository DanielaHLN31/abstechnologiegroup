<script type="text/javascript">
    ...
    $(document).on('click', '.delete-user-btn', function (e) {
        ...
        Swal.fire({
            title: 'Êtes-vous sûr ?',
            text: "La suppression de l\'utilisateur sera définitive !",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: `/users/delete/${userId}`, // URL du contrôle de suppression
                    ...
                    success: function (response) {
                        if (response.success) {
                            Swal.fire({
                                icon: 'success',
                                title: 'Supprimé!',
                                text: response.message || 'L\'utilisateur a été supprimé avec succès.',
                                customClass: {
