<script type="text/javascript">
    ...
    $(document).on('click', '.delete-role-btn', function (e) {
        ...
        Swal.fire({
            title: 'Êtes-vous sûr ?',
            text: "La suppression du rôle sera définitive !",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: `/roles/delete/${roleId}`, // URL du contrôle de suppression
                    ...
                    success: function (response) {
                        if (response.success) {
                            Swal.fire({
                                icon: 'success',
                                title: 'Supprimé!',
                                text: response.message || 'Le rôle a été supprimé avec succès.',
                                customClass: {
