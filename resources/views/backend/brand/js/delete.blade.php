    ...
    $(document).on('click', '.delete-brand-btn', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: `/brand/delete/${roleId}`, // URL du contrôle de suppression
                    ...
                    success: function (response) {
                        if (response.success) {
                            Swal.fire({
                                icon: 'success',
                                title: 'Supprimé!',
                                text: response.message || 'L\'brand a été supprimé avec succès.',
                                customClass: {
