...
<div class="wrap-header-cart js-panel-cart">
    ...
    <div class="header-cart flex-col-l p-l-25 p-r-20">
        ...
        <div class="header-cart-content flex-w js-pscroll">
            ...
            {{-- Liste des articles --}}
            <ul class="header-cart-wrapitem w-full" id="sidebar-cart-items" style="padding-left:0%">
...
<style>
    ...
    .header-cart-wrapitem {
        padding: 0px 0px 0; margin: 0; list-style: none;
        flex: 1;
    }
    ...
    .header-cart-item:hover {
        background: #f7f9fd;
        border-color: #c8d9f0;
        box-shadow: 0 2px 8px rgba(0,102,204,.07);
    }
    /* Lien invisible qui couvre tout l'item */
    ...
    /* Le bouton supprimer reste cliquable par-dessus */
    .sidebar-cart-remove {
        position: relative;
        z-index: 2;
    }
    ...
    .header-cart-item-name:hover { color: #0066CC !important; }
    ...
    .sidebar-cart-remove:hover {
        background: #feebeb; color: #CC1E1E !important; transform: scale(1.08);
    }
    ...
    (function () {
        ...
        window.renderSidebarCart = function (items, total, count) {
            ...
            items.forEach(function (item) {
                ...
                <li class="header-cart-item" data-item-id="${item.id}" data-url="/client/product/details/${item.product_id}" style="cursor:pointer;">
