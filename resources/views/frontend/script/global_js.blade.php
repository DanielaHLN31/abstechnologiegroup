...
<script>
            ...
            images.forEach((img, i) => {
                ...
                mainHtml += `
                    <div class="item-slick3">
                        <div class="wrap-pic-w pos-relative">
                            <img src="${src}" alt="Image produit" loading="lazy" style="width:100%;height:380px;object-fit:contain;display:block;">
                ...
                thumbsHtml += `
                    <div class="modal1-thumb-item ${i === 0 ? 'active' : ''}" data-index="${i}" style="border-color:${i === 0 ? '#717fe0' : '#e0e8f4'}">
                        <img src="${src}" alt="thumb"  loading="lazy" style="width:100%;height:100%;object-fit:cover;">
                    </div>`;
            });
                ...
                $list.append(`
                    <li class="header-cart-item" data-item-id="${item.id}" style="display:flex;align-items:center;gap:15px;padding:15px 0;border-bottom:1px solid #f5f5f5">
                        <div class="header-cart-item-img">
                            <img src="${imgSrc}" alt="${item.name}" loading="lazy" style="width:70px;height:70px;object-fit:cover;border-radius:8px">
                        </div>
                        <div style="flex:1;min-width:0">
                            <a href="client/product/details/${item.product_id}" loading="lazy" class="header-cart-item-name" style="font-size:14px;font-weight:600;color:#333;text-decoration:none;display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${item.name}</a>
   ...
   ================================================================ */
	...
	<script>
		// Filtre sticky - détection du stuck state pour l'ombre
		(function() {
			var wrap = document.getElementById('psFiltersWrap');
			if (!wrap) return;
			
			var headerH = window.innerWidth >= 992 ? 84 : 70;
