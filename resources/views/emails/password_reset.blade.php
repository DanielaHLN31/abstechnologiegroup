        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="content-section" style="padding: 30px; margin-bottom: 30px;">
            <tr>
                <td>
                    ...
                    <p style="font-size: 16px; line-height: 1.6; margin-bottom: 20px;">Vous recevez cet email car nous avons reçu une demande de réinitialisation de mot de passe pour votre compte sur ABS TECHNOLOGIE.</p>
                    ...
                    <p style="font-size: 16px; line-height: 1.6;">Merci d'utiliser ABS TECHNOLOGIE.</p>
                </td>
            </tr>
        </table>
    </td>
