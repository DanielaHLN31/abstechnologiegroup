...
(function () {
  ...
  const flatpickrDate = document.querySelector('#flatpickr-date'),
      ...
      flatpickrDate4 = document.querySelector('#flatpickr-date4'),
      flatpickrDate5 = document.querySelector('#flatpickr-date5'),
      flatpickrDate6 = document.querySelector('#flatpickr-date6'),
      flatpickrDate7 = document.querySelector('#flatpickr-date7'),
      flatpickrDate8 = document.querySelector('#flatpickr-date8'),
    flatpickrTime = document.querySelector('#flatpickr-time'),
      ...
      flatpickrTime7 = document.querySelector('#flatpickr-time7'),
      flatpickrTime8 = document.querySelector('#flatpickr-time8'),
