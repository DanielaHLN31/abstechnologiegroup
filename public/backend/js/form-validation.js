  ...
  (function () {
    const formValidationExamples = document.getElementById('formValidationExamples'),
      formValidationSelect2Ele = jQuery(formValidationExamples.querySelector('[name="formValidationSelect2"]')),
        form2ValidationSelect2Ele = jQuery(formValidationExamples.querySelector('[name="form2ValidationSelect2"]')),
    ...
    if (formValidationSelect2Ele.length) {
      ...
      // Select2 (Country)
      if (form2ValidationSelect2Ele.length) {
          form2ValidationSelect2Ele.wrap('<div class="position-relative"></div>');
          form2ValidationSelect2Ele
              .select2({
                  placeholder: 'Select country',
                  dropdownParent: form2ValidationSelect2Ele.parent()
              })
              .on('change', function () {
                  // Revalidate the color field when an option is chosen
                  fv.revalidateField('form2ValidationSelect2');
              });
      }
