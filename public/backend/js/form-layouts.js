...
(function () {
  ...
  formCheckInputPayment = document.querySelectorAll('.form-check-input-payment'),
     formCreditCard = document.querySelector('#form-credit-card'),
     formCash = document.querySelector('#form-cash');
  ...
  if (datepickerList) {
    ...
    // Fonction pour masquer tous les formulaires de méthode de paiement
    function hideAllPaymentForms() {
        formCreditCard.classList.add('d-none');
        formCash.classList.add('d-none');
    }

    // Fonction pour initialiser les formulaires de paiement
    function initializePaymentForms() {
        hideAllPaymentForms();
        formCreditCard.classList.remove('d-none');
    }
    ...
    formCheckInputPayment.forEach(function(paymentInput) {
        paymentInput.addEventListener('change', function(e) {
            ...
            if (paymentInputValue === 'credit-card') {
                formCreditCard.classList.remove('d-none');
            } else if (paymentInputValue === 'cash') {
    ...
    document.addEventListener('DOMContentLoaded', initializePaymentForms);
})();
